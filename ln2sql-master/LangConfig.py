...
class LangConfig:
	...
	def load(self, path):
		with open(path) as f:
			...
			self.avg_keywords = list(map(lambda x: x.lower(), self.avg_keywords))
			...
			self.sum_keywords = list(map(lambda x: x.lower(), self.sum_keywords))
			...
			self.max_keywords = list(map(lambda x: x.lower(), self.max_keywords))
			...
			self.min_keywords = list(map(lambda x: x.lower(), self.min_keywords))
			...
			self.count_keywords = list(map(lambda x: x.lower(), self.count_keywords))
			...
			self.junction_keywords = list(map(lambda x: x.lower(), self.junction_keywords))
			...
			self.disjunction_keywords = list(map(lambda x: x.lower(), self.disjunction_keywords))
			...
			self.greater_keywords = list(map(lambda x: x.lower(), self.greater_keywords))
			...
			self.less_keywords = list(map(lambda x: x.lower(), self.less_keywords))
			...
			self.between_keywords = list(map(lambda x: x.lower(), self.between_keywords))
			...
			self.order_by_keywords = list(map(lambda x: x.lower(), self.order_by_keywords))
			...
			# self.asc_keywords = self.asc_keywords[1:len(list(self.asc_keywords))]
			self.asc_keywords = list(map(lambda x: x.lower(), self.asc_keywords))
			...
			# self.desc_keywords = self.desc_keywords[1:len(list(self.desc_keywords))]
			self.desc_keywords = list(map(lambda x: x.lower(), self.desc_keywords))
			...
			self.group_by_keywords = list(map(lambda x: x.lower(), self.group_by_keywords))
			...
			self.negation_keywords = list(map(lambda x: x.lower(), self.negation_keywords))
			...
			# self.equal_keywords = self.equal_keywords[1:len(list(self.equal_keywords))]
			self.equal_keywords = list(map(lambda x: x.lower(), self.equal_keywords))
			...
			# self.like_keywords = self.like_keywords[1:len(list(self.like_keywords))]
			self.like_keywords = list(map(lambda x: x.lower(), self.like_keywords))
